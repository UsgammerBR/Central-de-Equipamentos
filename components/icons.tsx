...
export const LoadingBoxIcon = ({ className = 'w-32 h-32' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className={className} shapeRendering="geometricPrecision">
    ...
    <g transform="translate(50, 50) scale(0.9)" filter="url(#softDropShadowL)">
        ...
        {/* LED Animation: Start Green -> Turn Red -> Pulse Red */}
        <circle cx="35" cy="15" r="3">
             {/* 0% Green, 20% Red, 100% Red (Pulsing opacity below) */}
             <animate attributeName="fill" values="#22c55e; #ef4444; #ef4444" keyTimes="0; 0.2; 1" dur="2s" repeatCount="indefinite" />
             {/* Opacity Pulse: Solid green/red start, then fade out/in */}
             <animate attributeName="opacity" values="1; 1; 0.4; 1; 0.4; 1" keyTimes="0; 0.2; 0.4; 0.6; 0.8; 1" dur="2s" repeatCount="indefinite" />
        </circle>
    </g>
  </svg>
);
